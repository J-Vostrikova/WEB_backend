   ...
   <div id="form">
	...
	<form action="" method="POST">
	  ...
	  <label for="info"><b>Информация о себе:</b></label><br />
        <textarea id="info" name="info" <?php if(!empty($errors['info']))  print 'class="error"';?> <?php if(empty($errors['info'])&&!empty($values['info'])) print 'class="ok"';?>><?php isset($_COOKIE['info_error']) ? print trim($_COOKIE['info_error']) : print htmlspecialchars($values['info']) ?></textarea>
      <br />
